...
Бот має сучасний Web App інтерфейс!

**Як відкрити:**
1. Через @BotFather додай Menu Button
2. URL: `https://your-render-url.com/webapp`
3. Або через команду `/webapp`

**Функції Web App:**
- 🐷 Профіль хряка з візуалізацією
- 🍽️ Годування (MainButton)
